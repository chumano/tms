...
(function($) {
	$(document).ready(function() {
		$('#idheader').append('<div id="autoResizeTextareaCopy" style="box-sizing: border-box; -moz-box-sizing: border-box;  -ms-box-sizing: border-box; -webkit-box-sizing: border-box; display:none;"></div>'); //visibility: hidden;
