(function () {
    CHUNOApp.directive("demoTrackedTable", demoTrackedTable);
...
(function () {
    CHUNOApp.directive("demoTrackedTableRow", demoTrackedTableRow);
...
(function () {
    CHUNOApp.directive("demoTrackedTableCell", demoTrackedTableCell);
